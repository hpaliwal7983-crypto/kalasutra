...
function BuyerHomeScreen({user,go,openProduct,wishlist,toggleWishlist,cartCount,addToCart,setToast}:any){
 ...
 <button className="buyer-ai-promo" onClick={()=>go("buyerAI")}><div className="buyer-ai-promo-avatar"><img src="/assets/avatar-artisan.png" alt=""/></div><div className="buyer-ai-promo-copy"><strong>I’m KalaSutra AI!</strong><span>Tell me what you’re<br/>looking for today?</span><b><Icon name="mic"/> Start Talking</b></div><span className="buyer-ai-promo-leaf">✿</span></button>
...
function BuyerAIPage({go,user}:any){
 ...
 <div className="buyer-ai-scene"><div className="buyer-ai-flower flower-left">♧</div><div className="buyer-ai-flower flower-right">♧</div><div className="buyer-ai-portrait"><img src="/assets/avatar-artisan.png" alt="KalaSutra AI assistant"/></div><div className="buyer-ai-story">Different<br/>People<br/>Beautiful<br/>Stories<br/>One India ♡</div></div>
